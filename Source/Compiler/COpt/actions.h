...
simplact simple[] = {
    ...
    {ldb,   NULL,   stb,    1,      2,      NULL},
    {ldd,   NULL,   std,    1,      2,      NULL},
    {ldx,   NULL,   stx,    1,      2,      NULL},
    {pshs,  u,      pshs,   d,      2,      du},
    {pshs,  u,      pshs,   y,      2,      yu},
    {pshs,  x,      pshs,   d,      2,      dx},
    {pshs,  y,      pshs,   d,      2,      dy},
    {ldd,   NULL,   cmpd,   zero,   2,      2},
    {ldx,   NULL,   cmpx,   zero,   2,      2},
    {ldy,   NULL,   cmpy,   zero,   2,      2},
    {ldu,   NULL,   cmpu,   zero,   2,      2},
    {sty,   NULL,   cmpy,   zero,   2,      2},
    {stu,   NULL,   cmpu,   zero,   2,      2},
    {leas,  p2s,    puls,   upc,    1,      xupc},
